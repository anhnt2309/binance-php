...
class User extends Request
{
     ...
     * */
    public function subAccountTransferSubToSub(string $toEmail, string $asset, $amount)
    {
        $this->type = 'POST';
        $this->path = '/sapi/v1/sub-account/transfer/subToSub';
        $params = [
            "toEmail" => $toEmail,
            "asset" => $asset,
            "amount" => $amount,
    ...
    /**
     * 查看账户当前挂单 (USER_DATA)
    GET /sapi/v1/sub-account/transfer/subToMaster  (HMAC SHA256)
     * */
    public function subAccountTransferSubToMaster(string $asset, $amount)
    {
        $this->type = 'POST';
        $this->path = '/sapi/v1/sub-account/transfer/subToMaster';
        $params = [
            "asset" => $asset,
            "amount" => $amount,
        ];
